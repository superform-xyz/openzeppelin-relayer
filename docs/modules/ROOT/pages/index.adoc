...
|min_balance
|unsigned 64
|Minimum operating ballance for the relayer
...
|allowed_tokens
|Vector
|Definition of allowed token policy (see xref:solana_allowed_tokens_table[`Solana - Allowed Tokens Policy`] table)
...
[#solana_allowed_tokens_table]
Solana - Allowed Tokens Policy
[cols="1,1,2"]
|===
